...
function cleanTheData($) {
  ...
  // RESULTS: Not possible. TOo fucky.
  // let returnData = "";

  // let scriptNode = $('script:contains("ytInitialData")').contents();
  // let scriptClean = "";

  // // if scriptNode exists, parse it into json/js object
  // // https://stackoverflow.com/a/38873530/4096078
  // if (scriptNode) {
  //   // const dataNode = scriptNode.contents()
  //   // console.log(typeof returnData)
  //   const dataInner = scriptNode[0].data;

  //   const dataClean1 = dataInner.replace(/\r?\n|\r/g, "") // delete all \r
  //                         .replace(/\s/g,'') // delete all white space
  //                         .replaceAll(/\\/g,'@@@') // delete backslashes

  //   const dataClean2 = dataClean1.substring(dataClean1.indexOf('{')) // delete the initial variable


  //   returnData = dataClean2;
  //   // returnData = JSON.parse(dataClean2)
  ...
  // TODO: Element Approachs
  // get ytd-playlist-video-renderer
  // inside of that, get

  return JSON.stringify(returnData, JsonCircularCB());
